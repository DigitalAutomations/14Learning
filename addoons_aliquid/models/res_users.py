...
class ResUserInherit(models.Model):
    ...
    portal_order_access = fields.Selection([
        ('own', 'Propri Documenti'),
        ('all', 'Tutti i Documenti')
    ], string="Ordini", help="Propri Documenti: mostra solo i documenti dell'utente corrente. "
                                 "Tutti i documenti: mostra i documenti legati all'azienda di appartenenza")
    portal_invoice_access = fields.Selection([
        ('own', 'Propri Documenti'),
        ('all', 'Tutti i Documenti')
    ], string="Fatture", help="Propri Documenti: mostra solo i documenti dell'utente corrente. "
                                 "Tutti i documenti: mostra i documenti legati all'azienda di appartenenza")
    portal_ticket_access = fields.Selection([
        ('own', 'Propri Documenti'),
        ('all', 'Tutti i Documenti')
    ], string="Ticket", help="Propri Documenti: mostra solo i documenti dell'utente corrente. "
                                 "Tutti i documenti: mostra i documenti legati all'azienda di appartenenza")
    portal_subscription_access = fields.Selection([
        ('own', 'Propri Documenti'),
        ('all', 'Tutti i Documenti')
    ], string="Abbonamenti", help="Propri Documenti: mostra solo i documenti dell'utente corrente. "
                                 "Tutti i documenti: mostra i documenti legati all'azienda di appartenenza")
